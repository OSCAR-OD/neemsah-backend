                                  ...
                                  <tr>
                                      <td style="padding:0 35px;">
                                          ...
                                          <p style="text-align: left;color:#455056; font-size:15px;line-height:24px; margin:0;">
                                              <br />
                                              A customer with below information just booked a meeting schedule. Please find the information below and take necessary steps.
                                              <br /> 
                                             </p>
                                             ...
                                             <h4 style="text-align: left;color:#455056; font-size:15px;line-height:24px; margin:0;">
                                              ...
                                              Meeting Agenda: ${data.agenda}<br />
                                                ...
                                                <p style="text-align: left;color:#455056; font-size:15px;line-height:24px; margin:0;">
                                              Thank you. Also, please send meeting details as soon as possible.<br />
                                              Best Regards,
                                              <br />
