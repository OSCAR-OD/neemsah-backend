...
class NavbarController {
    async add(req: Request, res: Response) {
        try {
            const { industryName, slug, category, type } = req.body;
            ...
            const created = await NavbarService.add({ industryName, slug, category, type });
    ...
    async all(req: Request, res: Response) {
        try {
            ...
            let data: any = await NavbarService.all();
            if (page && size) {
    ...
    async single(req: Request, res: Response) {
        try {
            ...
            const data: any = await NavbarService.singleByField({ customID });
            if (!data) {
                return res
                    .status(OK)
    ...
    async edit(req: Request, res: Response) {
        try {
            ...
            const updated = await NavbarService.update({ customID }, {   name, email, phone, message,time, date,title, type });
            if (updated)
                return res
                    .status(OK)
                    .send(success(ErrorMessage.HTTP_OK, req.body));
    ...
    async delete(req: Request, res: Response) {
        try {
            const { customID } = req.params;
            const deleted = await NavbarService.destroy({ customID });
            if (deleted)
                return res
                    .status(OK)
                    .send(success(ErrorMessage.HTTP_OK, req.body));
