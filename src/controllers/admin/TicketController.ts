...
class TicketController {
    async add(req: Request, res: Response) {
        try {
            ...
            const created = await TicketService.add({  name, email, phone, message,time, date,title, type });
    ...
    async all(req: Request, res: Response) {
        try {
            ...
            let data: any = await TicketService.all();
            if (page && size) {
    ...
    async single(req: Request, res: Response) {
        try {
            ...
            const data: any = await TicketService.singleByField({ customID });
            if (!data) {
                return res
                    .status(OK)
    ...
    async edit(req: Request, res: Response) {
        try {
            ...
            const updated = await TicketService.update({ customID }, {   name, email, phone, message,time, date,title, type });
            if (updated)
                return res
                    .status(OK)
                    .send(success(ErrorMessage.HTTP_OK, req.body));
    ...
    async delete(req: Request, res: Response) {
        try {
            const { customID } = req.params;
            const deleted = await TicketService.destroy({ customID });
            if (deleted)
                return res
                    .status(OK)
                    .send(success(ErrorMessage.HTTP_OK, req.body));
